# Generated by Django 5.0.3 on 2024-05-03 05:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('referred_vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='referring_vendor', to='EMTA_APP.vendor')),
                ('referring_vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referred_vendors', to='EMTA_APP.vendor')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='EMTA_APP.vendor')),
            ],
        ),
        migrations.CreateModel(
